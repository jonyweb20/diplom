...
<symbol id="info-fill" fill="currentColor" viewBox="0 0 16 16">
    ...
    <div class="alert alert-success d-flex align-items-center col-6-md" role="alert">
